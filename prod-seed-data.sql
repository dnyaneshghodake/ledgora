...
(10, 1, 'GL-T1-CLR-OUT',    'IBC Outward Clearing',     'Inter-branch clearing outward',      'ASSET',     1,   1, 1, 0.0000, 'DEBIT',  SYSUTCDATETIME(), SYSUTCDATETIME()),
(11, 1, 'GL-T1-CLR-IN',     'IBC Inward Clearing',      'Inter-branch clearing inward',       'LIABILITY', 2,   1, 1, 0.0000, 'CREDIT', SYSUTCDATETIME(), SYSUTCDATETIME()),
(12, 1, 'GL-T1-SUSPENSE',   'Suspense Account',         'Suspense GL for parked entries',     'LIABILITY', 2,   1, 1, 0.0000, 'CREDIT', SYSUTCDATETIME(), SYSUTCDATETIME()),
...
(25, 2, 'GL-T2-CLR-OUT',    'IBC Outward Clearing',     'Inter-branch clearing outward',      'ASSET',     16,  1, 1, 0.0000, 'DEBIT',  SYSUTCDATETIME(), SYSUTCDATETIME()),
(26, 2, 'GL-T2-CLR-IN',     'IBC Inward Clearing',      'Inter-branch clearing inward',       'LIABILITY', 17,  1, 1, 0.0000, 'CREDIT', SYSUTCDATETIME(), SYSUTCDATETIME()),
(27, 2, 'GL-T2-SUSPENSE',   'Suspense Account',         'Suspense GL for parked entries',     'LIABILITY', 17,  1, 1, 0.0000, 'CREDIT', SYSUTCDATETIME(), SYSUTCDATETIME()),
...
(18, 1, 'T1-CUR-0001', 'ABC Enterprises Current',   'CURRENT', 'ACTIVE',  950000.0000, 'INR', 'BR001', 1, 'ABC Enterprises',   'GL-T1-CURRENT', 'NONE', 0, 'APPROVED', SYSUTCDATETIME(), 0, SYSUTCDATETIME()),
...
(28, 2, 'T2-CASH-BR003',     'Cash Account BR003',            'INTERNAL_ACCOUNT', 'ACTIVE', 4045000.0000, 'INR', 'BR003', 3, NULL,                'GL-T2-CASH',    'NONE', 0, 'APPROVED', SYSUTCDATETIME(), 0, SYSUTCDATETIME()),
...
(35, 2, 'T2-SAV-0001', 'Mohan Lal Savings',         'SAVINGS', 'ACTIVE',  145000.0000, 'INR', 'BR003', 3, 'Mohan Lal',         'GL-T2-SAVINGS', 'NONE', 0, 'APPROVED', SYSUTCDATETIME(), 0, SYSUTCDATETIME()),
...
(40, 2, 'T2-SAV-0006', 'Nisha Agarwal Savings',     'SAVINGS', 'ACTIVE',  112000.0000, 'INR', 'BR004', 4, 'Nisha Agarwal',     'GL-T2-SAVINGS', 'NONE', 0, 'APPROVED', SYSUTCDATETIME(), 0, SYSUTCDATETIME()),
...
(45, 2, 'T2-CUR-0001', 'Alpha Industries Current',  'CURRENT', 'ACTIVE',  750000.0000, 'INR', 'BR003', 3, 'Alpha Industries',  'GL-T2-CURRENT', 'NONE', 0, 'APPROVED', SYSUTCDATETIME(), 0, SYSUTCDATETIME()),
