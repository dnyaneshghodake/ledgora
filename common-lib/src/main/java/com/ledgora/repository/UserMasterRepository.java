 ...
 *
 * Provides CRUD operations and custom query methods for UserMaster.
 * Supports finding users by various keys and criteria.
 */
@Repository
public interface UserMasterRepository extends JpaRepository<UserMaster, String> {
     ...
     */
    @Query("SELECT COUNT(u) FROM UserMaster u WHERE u.usrBrCode = :brCode AND u.isActive = :isActive")
