 ...
 *
 * File Name      : D002001.DDF
 * File Desc      : User Master
 * Module Type    : 002/Application Level Maint.
 * Record Size    : Variable
 *
 * This entity represents a system user with authentication, authorization,
...
public class UserMaster {
    ...
    // ========== Primary Key ==========
    /**
     * Primary Key - User Code 1
     * Type: String (S), Size: 8
     */
    @Id
    ...
    // ========== Alternative Keys ==========
    /**
     * Alternative Key 1 - User Code 2
     * Type: Integer (I), Size: 4
     * Unique identifier for user code 2
     */
    @Column(name = "USR_CODE2", length = 8, unique = true)
    private Integer usrCode2;

    /**
     * Alternative Key 2 - User Code 3
     * Type: String (S), Size: 16
     * Unique identifier for user code 3
     */
    ...
    /**
     * User Branch Code - indicates the branch in which this user can pass vouchers.
     * Zeroes means he can pass for any branch.
     * Type: Integer (I), Size: 4
     */
    ...
    /**
     * Login From Other Branch allowed
     * Type: String (S), Size: 1
     * Values: Y/N
     */
    ...
    // ========== Group & Status ==========
    /**
     * Group Code - indexed with usrCode1
     * Type: Integer (I), Size: 2
     */
    ...
    /**
     * Password Change Period in Days
     * Type: Integer (I), Size: 4
     */
    ...
    /**
     * Minimum Login Frequency Forced
     * Type: String (S), Size: 1
     * Values: Y/N
     */
    ...
    /**
     * Maximum Bad Logins Per Instance
     * Type: Integer (I), Size: 4
     */
    ...
    /**
     * Access Profile System Entities
     * Type: String (S), Size: 1
     * Values: Y/N
     */
    ...
    /**
     * Active Serial Number Indicator
     * Type: Integer (I), Size: 1
     */
     ...
     * Type: Embedded Object (TMDbtrack)
     * Not Audited
     */
    @Embedded
    @AttributeOverrides({
    ...
    public String toString() {
        return "UserMaster{" +
                ...
                ", usrCode3='" + usrCode3 + '\'' +
                ", usrName='" + usrName + '\'' +
                ", usrShortName='" + usrShortName + '\'' +
                ", emailId='" + emailId + '\'' +
                ", usrBrCode=" + usrBrCode +
                ", grpCd=" + grpCd +
                ", status=" + status +
                ", isActive=" + isActive +
                ", lastSysLiDt=" + lastSysLiDt +
                '}';
    }
}
