...
/**
 * Phase 7: Comprehensive banking invariant integration tests.
 * Tests idempotency, maker-checker, day-closed rejection,
 * double-entry enforcement, and batch imbalance prevention.
 */
@SpringBootTest
@ActiveProfiles("test")
...
class LedgoraBankingInvariantTest {
    ...
    void testIdempotencyDuplicateRejection() {
        ...
        assertThrows(Exception.class, () -> transactionService.deposit(duplicateDto),
    ...
    void testDayClosedTransactionRejection() {
        ...
        assertThrows(Exception.class, () -> transactionService.deposit(dto),
    ...
    void testDoubleEntryEnforcementOnTransfer() {
        ...
        BigDecimal credits = ledgerEntryRepository.sumCreditsByTransactionId(txn.getId());
        assertEquals(0, debits.compareTo(credits),
                "Transfer journal must be balanced");
    }
    ...
    void testClosedBatchImmutable() {
        ...
        assertThrows(Exception.class, () -> batchService.updateBatchTotals(
    ...
    void testTenantIsolationOnAccounts() {
        ...
        boolean canSeeTenantAAccount = tenantBAccounts.stream()
                .anyMatch(a -> a.getAccountNumber().equals("ACC-ISO-A"));

        assertFalse(canSeeTenantAAccount,
                "Tenant B must NOT be able to see Tenant A's accounts");
    }
    ...
    void testOptimisticLockingPresent() {
        ...
        assertNotNull(account.getVersion(),
                "Account must have a version field for optimistic locking");
    }
    ...
    private TestData setupTestData(String suffix) {
        ...
        GeneralLedger glDeposit = glRepository.save(GeneralLedger.builder()
        ...
        GeneralLedger glCash = glRepository.findByGlCode("1100")
