...
/**
 * CBS Customer Master test suite. Tests: customer creation, freeze controls, validation,
...
class LedgoraCustomerCbsTest {
    ...
    void testDuplicateCustomerNumberRejected() {
        ...
        assertTrue(
                customerMasterRepository.existsByTenantIdAndCustomerNumber(
    ...
    void testCustomerRelationship() {
        ...
        var rels =
                relationshipRepository.findActiveByPrimaryCustomerIdAndTenantId(
    ...
    private Account createTestAccount(
            Tenant tenant, Branch branch, CustomerMaster cm, String accountNumber) {
        Account account =
                Account.builder()
                        .tenant(tenant)
