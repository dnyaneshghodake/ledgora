...
/**
 * CBS Balance Engine test suite.
 * Tests: shadow balance, actual balance, clearing flow, lien logic, available balance.
 */
@SpringBootTest
@ActiveProfiles("test")
...
class LedgoraCbsBalanceTest {
    ...
    void testShadowBalanceUpdate() {
        ...
        cbsBalanceEngine.updateShadowBalance(account.getId(), new BigDecimal("5000.0000"), VoucherDrCr.CR);

        AccountBalance balance = cbsBalanceEngine.getCbsBalance(account.getId());
        assertEquals(0, new BigDecimal("5000.0000").compareTo(balance.getShadowTotalBalance()),
    ...
    void testActualBalanceUpdate() {
        ...
        cbsBalanceEngine.updateActualBalance(account.getId(), new BigDecimal("3000.0000"), VoucherDrCr.CR);

        AccountBalance balance = cbsBalanceEngine.getCbsBalance(account.getId());
        assertEquals(0, new BigDecimal("3000.0000").compareTo(balance.getActualTotalBalance()),
                "Actual total balance should be updated");
        assertEquals(0, new BigDecimal("3000.0000").compareTo(balance.getActualClearedBalance()),
    ...
    void testClearingFlow() {
        ...
        cbsBalanceEngine.updateActualBalance(account.getId(), new BigDecimal("10000.0000"), VoucherDrCr.CR);
        ...
        assertEquals(0, new BigDecimal("2000.0000").compareTo(afterClearing.getUnclearedEffectBalance()),
                "Uncleared effect should be 2000");
        assertEquals(0, new BigDecimal("8000.0000").compareTo(afterClearing.getActualClearedBalance()),
        ...
        assertEquals(0, BigDecimal.ZERO.compareTo(afterMove.getUnclearedEffectBalance()),
                "Uncleared effect should be 0 after move");
        assertEquals(0, new BigDecimal("10000.0000").compareTo(afterMove.getActualClearedBalance()),
    ...
    void testLienLogic() {
        ...
        AccountBalance balance = cbsBalanceEngine.getCbsBalance(account.getId());
        assertEquals(0, new BigDecimal("3000.0000").compareTo(balance.getLienBalance()),
                "Lien balance should be 3000");
        assertEquals(0, new BigDecimal("7000.0000").compareTo(balance.getAvailableBalance()),
    ...
    void testLienExceedingAvailableFails() {
        ...
        cbsBalanceEngine.updateActualBalance(account.getId(), new BigDecimal("1000.0000"), VoucherDrCr.CR);
    ...
    void testAvailableBalanceFormula() {
        ...
        cbsBalanceEngine.updateActualBalance(account.getId(), new BigDecimal("20000.0000"), VoucherDrCr.CR);
        cbsBalanceEngine.updateClearingBalance(account.getId(), new BigDecimal("5000.0000")); // uncleared
    ...
    void testDebitReducesActualBalance() {
        ...
        cbsBalanceEngine.updateActualBalance(account.getId(), new BigDecimal("10000.0000"), VoucherDrCr.CR);
        cbsBalanceEngine.updateActualBalance(account.getId(), new BigDecimal("3000.0000"), VoucherDrCr.DR);

        AccountBalance balance = cbsBalanceEngine.getCbsBalance(account.getId());
        assertEquals(0, new BigDecimal("7000.0000").compareTo(balance.getActualTotalBalance()),
