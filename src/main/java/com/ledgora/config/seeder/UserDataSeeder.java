...
public class UserDataSeeder {
    ...
    /**
     * Seeds realistic users for additional tenants (T2–T5). Each tenant gets: admin, manager,
     * teller, maker, checker, auditor (minimum CBS staff).
     */
    public void seedForAdditionalTenants(
        ...
        if (t2Hq != null && t2 != null) {
            create(
                    ...
                    "admin123",
                    "Suresh Mehta",
                    "suresh@partner-bank.in",
                    "+91-9200000001",
                    t2Hq,
                    Set.of(adminRole, tenantAdminRole),
                    t2,
                    TenantScope.SINGLE);
            create(
                    "t2_manager",
                    "mgr123",
                    "Kavita Joshi",
                    "kavita@partner-bank.in",
                    "+91-9200000002",
                    t2Hq,
                    Set.of(managerRole, checkerRole),
                    t2,
                    TenantScope.SINGLE);
            create(
                    "t2_teller",
                    "teller123",
                    "Rahul Verma",
                    "rahul@partner-bank.in",
                    "+91-9200000003",
                    t2Br1 != null ? t2Br1 : t2Hq,
                    Set.of(tellerRole, makerRole),
                    t2,
                    TenantScope.SINGLE);
            create(
                    "t2_maker",
        ...
        if (t4Hq != null && t4 != null) {
            ...
            create(
                    ...
                    "teller123",
                    "Bharat Gaikwad",
                    "bharat@maha-gramin.in",
                    "+91-9400000003",
                    t4Br1 != null ? t4Br1 : t4Hq,
                    Set.of(tellerRole, makerRole),
                    t4,
                    TenantScope.SINGLE);
            create(
                    ...
                    "teller123",
                    "Mangal Kale",
                    "mangal@maha-gramin.in",
                    "+91-9400000004",
                    t4Br2 != null ? t4Br2 : t4Hq,
                    Set.of(tellerRole, makerRole),
                    t4,
                    TenantScope.SINGLE);
            create(
            ...
            create(
                    ...
                    "branch123",
                    "Ashok More",
                    "ashok@maha-gramin.in",
                    "+91-9400000007",
                    t4Br1 != null ? t4Br1 : t4Hq,
                    Set.of(branchMgrRole, checkerRole),
                    t4,
                    TenantScope.SINGLE);
        ...
        if (t5Hq != null && t5 != null) {
            ...
            create(
                    ...
                    "maker123",
                    "Arjun Reddy",
                    "arjun@finserv-capital.in",
                    "+91-9500000003",
                    t5Br1 != null ? t5Br1 : t5Hq,
                    Set.of(makerRole),
                    t5,
                    TenantScope.SINGLE);
            create(
