...
/**
 * CBS DataSeeder: Module 10 — CBS CustomerMaster + Tax Profiles.
 * Seeds verified/pending customers with PAN, Aadhaar, GST tax profiles.
 */
@Component
public class CbsCustomerSeeder {
    ...
    public void seed(Tenant defaultTenant) {
        ...
        seedWithTax(defaultTenant, "CBS-CUST-001", "Rajesh", "Kumar",
                LocalDate.of(1985, 3, 15), "ABCDE1234F", "9100000001",
                "rajesh.kumar@email.com", "123 MG Road, Mumbai",
                "VERIFIED", "INDIVIDUAL", "123456789012", null);

        seedWithTax(defaultTenant, "CBS-CUST-002", "Priya", "Sharma",
                LocalDate.of(1990, 7, 22), "FGHIJ5678K", "9100000002",
                "priya.sharma@email.com", "456 Park Avenue, Delhi",
                "VERIFIED", "INDIVIDUAL", "987654321098", null);

        seedWithTax(defaultTenant, "CBS-CUST-003", "Acme", "Corp",
                null, "KLMNO9012P", "9100000003",
                "finance@acmecorp.com", "789 Business Park, Bangalore",
                "VERIFIED", "CORPORATE", null, "29KLMNO9012PZAB");
        ...
        CustomerMaster cm4 =
                CustomerMaster.builder()
                        ...
                        .firstName("Amit").lastName("Patel").fullName("Amit Patel")
                        .dob(LocalDate.of(1988, 11, 5))
                        .nationalId("PQRST3456U").phone("9100000004")
                        .email("amit.patel@email.com")
                        .address("321 Hill Street, Hyderabad")
                        .kycStatus("PENDING").customerType("INDIVIDUAL")
    ...
    private void seedWithTax(
            Tenant tenant, String custNo, String first, String last,
            LocalDate dob, String nationalId, String phone,
            String email, String address,
            String kycStatus, String custType,
            String aadhaar, String gst) {
        CustomerMaster cm =
                CustomerMaster.builder()
                        .tenant(tenant)
                        .customerNumber(custNo)
                        .firstName(first).lastName(last).fullName(first + " " + last)
                        .dob(dob).nationalId(nationalId).phone(phone)
                        .email(email).address(address)
                        .kycStatus(kycStatus).customerType(custType)
        ...
        CustomerTaxProfile tp =
                CustomerTaxProfile.builder()
                        .tenant(tenant).customerMaster(cm)
                        .panNumber(nationalId)
                        .aadhaarNumber(aadhaar)
                        .gstNumber(gst)
                        .tdsApplicable(true)
                        .tdsRate("CORPORATE".equals(custType)
