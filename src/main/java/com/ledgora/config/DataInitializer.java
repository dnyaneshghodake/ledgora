...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initUsers() {
        ...
        Role tellerRole =
                roleRepository
                        .findByName(RoleName.ROLE_TELLER)
        ...
        Role makerRole =
                roleRepository
                        .findByName(RoleName.ROLE_MAKER)
                        .orElseThrow(() -> new RuntimeException("ROLE_MAKER not found"));
        Role checkerRole =
                roleRepository
                        .findByName(RoleName.ROLE_CHECKER)
        ...
        Role opsRole =
                roleRepository
                        .findByName(RoleName.ROLE_OPERATIONS)
                        .orElseThrow(() -> new RuntimeException("ROLE_OPERATIONS not found"));
        Role auditorRole =
                roleRepository
                        .findByName(RoleName.ROLE_AUDITOR)
        ...
        Role tenantAdminRole =
                roleRepository
                        .findByName(RoleName.ROLE_TENANT_ADMIN)
                        .orElseThrow(() -> new RuntimeException("ROLE_TENANT_ADMIN not found"));
        Role branchMgrRole =
                roleRepository
                        .findByName(RoleName.ROLE_BRANCH_MANAGER)
        ...
        Role systemRole =
                roleRepository
                        .findByName(RoleName.ROLE_SYSTEM)
        ...
        log.info(
                "  [Users] 17 users ready (admin, superadmin, tenantadmin, branchmgr1, manager, teller1-3, customer1-4, maker1, checker1, ops1, auditor1, SYSTEM_AUTO)");
    }

    /**
     * Helper — creates a user only if the username does not already exist. Returns the persisted
     * (or existing) User entity. Uses default tenant with SINGLE scope.
     */
    ...
    private void initGLHierarchy() {
        ...
        GeneralLedger assets =
                createGL("1000", "Assets", "Total Assets", GLAccountType.ASSET, null, 0, "DEBIT");
