...
/**
 * PART 14: Custom health indicator for the Ledgora platform. Checks: ledger integrity (SUM debits =
 * SUM credits), business date status, and basic repository connectivity.
 */
@Component
public class LedgoraHealthIndicator implements HealthIndicator {
    ...
    public Health health() {
        try {
            ...
            return builder.withDetail("businessDate", businessDate.toString())
