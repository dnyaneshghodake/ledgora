...
/**
 * PART 4: Idempotency service for financial operations.
 * Checks and stores idempotency keys to prevent duplicate processing.
 */
@Service
public class IdempotencyService {
    ...
    public void completeKey(String key, String responseData) {
        idempotencyKeyRepository.findByKey(key).ifPresent(k -> {
