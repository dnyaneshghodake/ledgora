 ...
 *
 * <p>The User entity carries failedLoginAttempts and isLocked fields. This service checks both
 * before allowing authentication: - isActive must be true - isLocked must be false -
 * failedLoginAttempts must be below MAX_FAILED_ATTEMPTS (auto-locks at threshold)
 *
 * <p>Lockout is triggered by AuthenticationFailureListener (increments counter, sets isLocked).
...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if (user.getFailedLoginAttempts() != null
            ...
            log.warn(
                    "SECURITY: User {} locked due to {} failed login attempts",
                    username,
