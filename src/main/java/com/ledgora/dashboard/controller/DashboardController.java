...
/**
 * Dashboard controller — extracts the authenticated user's roles from the SecurityContext and
 * passes them to the JSP view so that role-based conditional rendering can work via JSTL.
 */
@Controller
