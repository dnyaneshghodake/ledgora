...
/**
 * PART 9: Real-time balance engine. Responsibilities: - Calculate available balance - Apply holds -
...
public class BalanceEngineService {
    ...
    public void placeHold(Long accountId, BigDecimal holdAmount) {
        ...
        log.info(
                "Hold placed on account {}: amount={}, total holds={}",
                accountId,
                holdAmount,
    ...
    public void releaseHold(Long accountId, BigDecimal holdAmount) {
        ...
        accountBalanceRepository.save(balance);
        log.info(
                "Hold released on account {}: amount={}, remaining holds={}",
                accountId,
                holdAmount,
                newHold);
    }
    ...
    public AccountBalance refreshBalanceCache(Long accountId) {
        ...
        accountBalanceRepository.save(balance);
        log.debug(
                "Balance cache refreshed for account {}: ledger={}, available={}",
                accountId,
                ledgerBalance,
