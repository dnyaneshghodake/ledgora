...
/**
 * PART 3: Event listener for ledger-related events. Listens to TransactionCreatedEvent and triggers
 * ledger posting. Note: In the current implementation, ledger posting is done synchronously within
 * the transaction service. This listener provides the extensibility point for async processing if
...
public class LedgerEventListener {
    ...
    public void onTransactionCreated(TransactionCreatedEvent event) {
        log.info(
                "TransactionCreatedEvent received for transaction: {}",
    ...
    public void onLedgerPosted(LedgerPostedEvent event) {
        log.info(
                "LedgerPostedEvent received for journal: {} (transaction: {})",
