...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h3><i class="bi bi-cash-coin"></i> Cash Withdrawal</h3>
...
<form method="post" action="${pageContext.request.contextPath}/transactions/withdraw" id="withdrawForm"
      ...
      data-is-holiday="${isHoliday}" data-txn-type="WITHDRAWAL">
        ...
        <div class="card-body py-2">
            <div class="row align-items-center g-2">
                <div class="col-md-3">
                    ...
                    <span class="badge bg-danger fs-6">WITHDRAWAL</span>
                </div>
                <div class="col-md-2">
    ...
    <div class="card shadow-sm mb-3">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-6">
                    <label for="accountNumber" class="form-label cbs-field-required">Source Account</label>
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-header bg-white">
            <h5 class="mb-0"><i class="bi bi-cash-coin me-2"></i>Transaction Details</h5>
        </div>
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-3">
    ...
    <div class="d-flex gap-2 align-items-center">
        <button type="submit" class="btn btn-warning btn-lg" id="submitBtn" ${isHoliday ? 'disabled' : ''}>
            <i class="bi bi-cash-coin"></i> Submit Withdrawal
        </button>
