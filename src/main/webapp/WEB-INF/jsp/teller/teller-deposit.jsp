...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h3><i class="bi bi-arrow-down-circle"></i> Teller Cash Deposit</h3>
...
<form method="post" action="${pageContext.request.contextPath}/teller/deposit" id="tellerDepositForm">
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="narration" id="narration" class="form-control" maxlength="500" placeholder="Cash deposit narration"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-3">
        ...
        <div class="card-body">
            <table class="table table-bordered table-sm">
                ...
                <tfoot>
                    <tr class="table-success"><td class="fw-bold">Grand Total</td><td></td><td class="text-end fw-bold" id="grandTotal">0.00</td></tr>
                </tfoot>
            </table>
        </div>
    </div>

    <button type="submit" class="btn btn-success btn-lg" id="submitBtn"><i class="bi bi-arrow-down-circle"></i> Submit Deposit</button>
...
(function(){
    ...
    var form = document.getElementById('tellerDepositForm');
