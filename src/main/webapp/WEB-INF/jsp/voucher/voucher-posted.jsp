...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3><i class="bi bi-check2-square"></i> Posted Vouchers</h3>
...
<div class="card shadow">
    <div class="card-header bg-white d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Successfully Posted Vouchers</h5>
        <span class="badge bg-success">${not empty vouchers ? vouchers.size() : 0} Posted</span>
    </div>
    <div class="card-body">
        <c:choose>
            ...
            <c:otherwise>
                <div class="text-center py-5 text-muted">
                    ...
                    <p class="mt-2">No posted vouchers found.</p>
                </div>
            </c:otherwise>
        </c:choose>
    </div>
