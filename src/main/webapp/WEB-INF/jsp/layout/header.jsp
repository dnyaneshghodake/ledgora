    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/fx-rates">
                        <i class="bi bi-currency-exchange"></i> FX Rates
                    </a>
                </li>
                </c:if>
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <span class="nav-link text-light">
                        ...
                        <%-- Show role badge --%>
                        <c:if test="${sessionScope.isAdmin}"><span class="badge bg-danger ms-1">Admin</span></c:if>
                        <c:if test="${sessionScope.isManager}"><span class="badge bg-warning text-dark ms-1">Manager</span></c:if>
                        <c:if test="${sessionScope.isTeller}"><span class="badge bg-info ms-1">Teller</span></c:if>
                        <c:if test="${sessionScope.isCustomer && !sessionScope.isAdmin && !sessionScope.isManager && !sessionScope.isTeller}"><span class="badge bg-secondary ms-1">Customer</span></c:if>
                    </span>
                </li>
                <li class="nav-item">
